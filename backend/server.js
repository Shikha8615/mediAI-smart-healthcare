...
const allowedOrigins = [
  "https://medi-ai-smart-healthcare.vercel.app",
  "https://medi-ai-smart-healthcare-git-main-shikha8615s-projects.vercel.app"
];

// ✅ CORS FIX (handles preflight + multiple origins)
app.use(cors({
...
// ✅ VERY IMPORTANT (fixes 405 / preflight error)
app.options("*", cors());
